 ...
 */
#[\Symfony\Component\Console\Attribute\AsCommand(name: 'propel:migration:migrate', description: 'Executes the next migrations up')]
class MigrationMigrateCommand extends AbstractCommand
{
    ...
    {
        $this
            ->setDefinition([new InputOption('--up', '', InputOption::VALUE_NONE, 'Executes the next migration up'), new InputOption('--down', '', InputOption::VALUE_NONE, 'Executes the next migration down')])
            ->setHelp(<<<EOT
