...
{
    public const MODEL_CLASS = 'Propel\Bundle\PropelBundle\Tests\Fixtures\Model\Translation';
    ...
    public function testLoadFiltersLocaleAndDomain()
    {
        ...
        $expected = ['test' => ['example.key' => 'This is an example translation.']];
    ...
    {
        $catalogue = new MessageCatalogue('en_US', ['test' => ['example.key' => 'This is an example translation.'], 'test2' => ['example.key' => 'This is an example translation.']]);
        ...
        $expected = [['key' => 'example.key', 'message' => 'This is an example translation.', 'locale' => 'en_US', 'domain' => 'test'], ['key' => 'example.key', 'message' => 'This is an example translation.', 'locale' => 'en_US', 'domain' => 'test2']];
    ...
    {
        return new ModelTranslation(self::MODEL_CLASS, ['columns' => ['translation' => 'message']]);
    }
}
